      ...
      child: Scaffold(
        body: Container(
          decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/illustartions/illustration-13.png"),opacity: 0.1)
          ),
                  ...
                  children: [
                              ...
                              children: [
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          ...
                                          Text("Using Java",style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 40,fontWeight: FontWeight.bold
                                          ),
                                          ),
                                ...
                                Expanded(
                                    child: Container(
                                      child: Image(
                                          image: AssetImage(
                                              "assets/illustartions/illustration-13.png")),
                                    )),
                              ],
                            ),
                          ),
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => AD_video()));
                        },
                        child: Container(
