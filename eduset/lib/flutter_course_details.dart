import 'package:eduset/course_video_flutter.dart';
      ...
      child: Scaffold(
        body: Container(
          decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/illustartions/illustration-01.png"),opacity: 0.3)
          ),
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          ...
                                          Text("Flutter for",style: TextStyle(
                                              color: Colors.white,
