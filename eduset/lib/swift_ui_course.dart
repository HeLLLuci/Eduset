import 'package:eduset/swift_video.dart';
...
class Suic extends StatefulWidget {
  const Suic({Key? key}) : super(key: key);

  @override
  State<Suic> createState() => _SuicState();
}
      ...
      child: Scaffold(
        body: Container(
          decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/illustartions/illustration-03.png"),opacity: 0.3)
          ),
                  ...
                  children: [
                              ...
                              children: [
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          ...
                                          Text("Build an App",style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 40,fontWeight: FontWeight.bold
                                          ),
                                          ),
                                          Text("Using Swift UI",style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 40,fontWeight: FontWeight.bold
                                          ),
                                          ),
                                ...
                                Expanded(
                                    child: Container(
                                      child: Image(
                                          image: AssetImage(
                                              "assets/illustartions/illustration-03.png")),
                                    )),
                              ],
                            ),
                          ),
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (Context) => Swift_video()));
                        },
                        child: Container(
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Text(
                        "Three years ago i can't write even a single line of code but by enrolling this course i have"
